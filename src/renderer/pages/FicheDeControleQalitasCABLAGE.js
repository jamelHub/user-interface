...
import tableData from './dataCABLAGE';
import { useLocation } from 'react-router-dom';

const FicheDeControleQalitasCABLAGE = () => {
  ...
  return (
    <div>
      <HeaderWithNavigation pageTitle="Fiche De Controle Qualitas pour CABLAGE" />
      <div className="page-container">
        <div className="no-background">
          <div className="logo-and-title">
            ...
            >
              <em>Fiche De Controle Qualitas pour CABLAGE</em>
            </h2>
          </div>
...
export default FicheDeControleQalitasCABLAGE;
