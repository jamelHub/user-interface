...
import tableData from './dataTRAD';
import { useLocation } from 'react-router-dom';

const FicheDeControleQalitasTRAD = () => {
  ...
  return (
    <div>
      <HeaderWithNavigation pageTitle="Fiche De Controle Qualitas pour TRAD" />
      <div className="page-container">
        <div className="no-background">
          <div className="logo-and-title">
            ...
            >
              <em>Fiche De Controle Qualitas pour TRQD</em>
            </h2>
          </div>
...
export default FicheDeControleQalitasTRAD;
